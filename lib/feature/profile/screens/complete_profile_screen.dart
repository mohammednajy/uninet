...
class _CompleteProfileScreenState extends State<CompleteProfileScreen> {
  ...
  late TextEditingController chasingDescription;
  @override
  void initState() {
    super.initState();
    ...
    chasingDescription = TextEditingController();
  }
                ...
                child: ListView(
                  children: [
                    ...
                    Text(
                      ...
                      style:
                          context.style.headlineMedium!.copyWith(fontSize: 14),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
                    ...
                    TextFieldWidget(
                      ...
                      readOnly: true,
                      controller: TextEditingController(text: chasingCategory),
                      onTap: () {
                        showModalBottomSheet(
                            context: context,
                            barrierColor: Colors.grey,
