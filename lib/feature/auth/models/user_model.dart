...
class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      chasingCategory: map['chasingCategory'] != null ? map['chasingCategory'] as String : null,
      chasingDescription: map['chasingDescription'] != null ? map['chasingDescription'] as String : null,
    );
  }
